        ...
        <form method="POST" id="validate_form" enctype="multipart/form-data" method="post" action="{{ route('teacher.TeacherBasicDetails_add') }}">
            ...
            <!-- Email Address -->
             <div class="mt-4">
                ...
                <x-input id="name" class="block mt-1 w-full" type="text" value="{{$basic_info->speciality_strength}}"  name="speciality_strength"  required autofocus />
            </div>
           <div class="mt-4">
              <x-label for="gender" :value="__('Gender')"/>
                            <div class="">
                                ...
                                <option value="Transgender" {{ $basic_info->gender == "Transgender" ? 'selected' : '' }}>Transgender</option>
                                </select>
         ...
         <div class="mt-4">
                ...
                <x-input id="date" class="block mt-1 w-full" type="date" name="dob" :value="old('dob')" value="{{$basic_info->dob}}" required />
            </div>
