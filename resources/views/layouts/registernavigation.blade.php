...
<div class="hidden sm:flex sm:items-center sm:ml-6">
  ...
  <div class="ml-1">
   ...
   <div class="dropdown-content">
    <a href="#">{{ __('My Jobs') }}</a>
    <a href="#">{{ __('Search all Jobs') }}</a>
    <a href="#"> {{ __('Search Online Jobs') }}</a>
    <a href="#"> {{ __('Reviews') }}</a>
  </div>
</div> 
</div>     
...
<div class="dropdown">
  ...
  <div class="dropdown-content">
    ...
    <a href="{{ route('teacher.TeacherBasicDetails') }}">{{ __('Education') }}</a>
    <a href="{{ route('teacher.TeacherBasicDetails') }}"> {{ __('Experience') }}</a>
    <a href="{{ route('teacher.TeacherBasicDetails') }}"> {{ __('Teaching Details') }}</a>
    <a href="{{ route('teacher.TeacherBasicDetails') }}">{{ __('Profile Description') }}</a>
    <a href="{{ route('teacher.TeacherBasicDetails') }}"> {{ __('Phone') }}</a>
